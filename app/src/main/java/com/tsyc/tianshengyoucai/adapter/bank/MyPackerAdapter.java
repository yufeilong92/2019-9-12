 ...
 * @Purpose : 红包
 */
public class MyPackerAdapter extends RecyclerView.Adapter<MyPackerAdapter.PackViewholer> {

    private Context mContext;
    private List<RedVo.ResultBean.DataBean> mData;
    private final LayoutInflater mInflater;

    public MyPackerAdapter(Context mContext, List<RedVo.ResultBean.DataBean> mData ) {
    ...
    public void onBindViewHolder(@NonNull PackViewholer holder, int position) {
        ...
        holder.mTvRedPackeContent.setVisibility(View.GONE);
