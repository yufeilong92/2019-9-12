 ...
 * @Purpose : 评价中图片适配器
 */
public class EvaluateImgAdapter extends RecyclerView.Adapter<EvaluateImgAdapter.ImageViewHolde> {
    private Context mContext;
    private List<String> mData;
    private final LayoutInflater mInflater;

    public EvaluateImgAdapter(Context mContext, List<String> mData) {
    ...
    public ImageViewHolde onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.item_evaluate_img, null);
