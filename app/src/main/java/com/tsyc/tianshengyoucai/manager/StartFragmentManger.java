...
public  class StartFragmentManger {

    private static Activity mContext;
    public static final String CNT_PARAMETE_TITLE = "param_title";

    public StartFragmentManger(FragmentActivity m) {
        mContext = m;
    }
    ...
    public void jumpToFoResulBU(Context mContext,Class<?> clazz, int resultCode,String title) {
        Intent intentB = new Intent();
        intentB.setClass(mContext, clazz);
        intentB.putExtra(CNT_PARAMETE_TITLE, title);
        ((Activity) mContext).startActivityForResult(intentB, resultCode);
    ...
    public void jumpToFoResultBU(Context mContext,Class<?> clazz, Bundle bundle, int resultCode) {
        Intent intentB = new Intent();
        intentB.setClass(mContext, clazz);
        intentB.putExtras(bundle);
        ((Activity) mContext).startActivityForResult(intentB, resultCode);
