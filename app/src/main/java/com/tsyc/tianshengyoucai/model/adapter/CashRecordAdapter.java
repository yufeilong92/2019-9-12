 ...
 */
public class CashRecordAdapter extends BaseQuickAdapter<CashRecordBean.ResultBean.ListBean.DataBean, BaseViewHolder> {

    public CashRecordAdapter(@Nullable List<CashRecordBean.ResultBean.ListBean.DataBean> data) {
        super(R.layout.layout_record_item, data);
    }

    @Override
    protected void convert(BaseViewHolder holder, CashRecordBean.ResultBean.ListBean.DataBean dataBean) {
