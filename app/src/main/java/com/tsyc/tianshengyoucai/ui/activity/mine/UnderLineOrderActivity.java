...
import com.tsyc.tianshengyoucai.ui.fragment.sub.order.SubOrderFragment;
...
public class UnderLineOrderActivity extends BaseActivity {
    ...
    public void initView() {
        mTvTitle.setText(getString(R.string.under_line_order));
    ...
    public void initData() {
        ...
        for (int i = 0; i < titles.length; i++) {
            SubOrderFragment orderFragment = new SubOrderFragment();
