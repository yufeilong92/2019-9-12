 ...
 * File description： 发布的红包界面
 */
public class RelRedBagListActivity extends BaseActivity {
    ...
    public void initView() {
        mTvTitle.setText(getString(R.string.text_bag_manage));
    ...
    public void initData() {
        ...
        for (int i = 0; i < titles.length; i++) {
            RedBagListFragment orderFragment = new RedBagListFragment();
