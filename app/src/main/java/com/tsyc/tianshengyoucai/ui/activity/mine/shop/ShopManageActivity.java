...
public class ShopManageActivity extends BaseActivity {
    ...
    private String[] titles = {"出售中", "已下架", "审核中"};
    ...
    public void initView() {
        mTvTitle.setText(getString(R.string.text_shop_manage));
    ...
    public void initData() {
        ...
        for (int i = 0; i < titles.length; i++) {
            ShopManageFragment orderFragment = new ShopManageFragment();
