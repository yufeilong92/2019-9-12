...
import com.tsyc.tianshengyoucai.ui.fragment.sub.UserCashRecordFragment;
 ...
 * author：van
 * CreateTime：2019/8/8
 * File description：用户 佣金 余额  提现记录
 */
public class UserCashRecordActivity extends BaseActivity {
    ...
    private static String[] titles = new String[]{"审核中", "已到帐", "审核失败"};
    ...
    public void initData() {
        ...
        for (int i = 0; i < titles.length; i++) {
            UserCashRecordFragment orderFragment = new UserCashRecordFragment();
