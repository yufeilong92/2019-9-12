 ...
 * @Purpose :职位列表
 */
public class PositionListsActivity extends Base2Activity {
...
//        setContentView(R.layout.activity_position_lists);
//        initView();
//    }

    @Override
    protected int getComtentView() {
        return R.layout.activity_position_lists;
    }
    ...
    private void loadData(boolean refresh) {
        ...
        RequestJobHttp.getSingleton(this).requestJobsRecommend(String.valueOf(mPage), new RequestResultCallback() {
            @Override
