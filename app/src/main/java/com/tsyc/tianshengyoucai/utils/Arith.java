...
public class Arith {
    ...
    public static double sub(double value1, double value2) {
        ...
        return b1.subtract(b2).doubleValue()/* < 0 ? 0.01 : b1.subtract(b2).doubleValue()*/;
    }
    ...
    public static String keepTwoDecimalPlaces(double number) {
        String result = new DecimalFormat("#0.00").format(number < 0 ? 0.01 : number);
        return result;
    }
