...
public class SettingUtil {
    ...
    private SharedPreferences setting = PreferenceManager.getDefaultSharedPreferences(AppContext.getInstance());
     ...
     * 获取是否开启无图模式
     */
    boolean getIsNoPhotoMode() {
        return setting.getBoolean("switch_noPhotoMode", false) && NetWorkUtils.isNetworkAvailable(AppContext.getInstance());
    }
     ...
     */
    public int getColor() {
        int defaultColor = AppContext.getInstance().getResources().getColor(R.color.colorPrimary);
    ...
    public boolean getIsVideoAutoPlay() {
        return setting.getBoolean("video_auto_play", false) && NetWorkUtils.isWifiConnected(AppContext.getInstance());
    }
    ...
    public int getTextSize() {
        return setting.getInt("textsize", 18);
    }
    ...
    public int getProgress() {
        return setting.getInt("progress", 0);
    }
    ...
    public void setProgress(int textSize) {
        setting.edit().putInt("progress", textSize).apply();
    }
    ...
    public String getTitle() {
        return setting.getString("title_text", "");
    }
    ...
    public void setTitle(String titleText) {
        setting.edit().putString("title_text", titleText).apply();
    }
