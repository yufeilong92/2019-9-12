 ...
 * 修改日期：
 */
public class MClipIndicatorTitleView extends View implements IMeasurablePagerTitleView {
    private String mText;
    private int mTextColor;
    private int mClipColor;
    private boolean mLeftToRight;
    private float mClipPercent;
    private int selectSize = sp2px(16);
    private int unselectSize = sp2px(15);

    private Paint mPaint;
    private Rect mTextBounds = new Rect();
    private boolean isSelect = false,isDeselected = false;
    ...
    public MClipIndicatorTitleView(Context context) {
        super(context);
        init(context);
    }
    ...
    public void onDeselected(int index, int totalCount) {
        mPaint.setTextSize(unselectSize);
